...
@AutoValue
public abstract class EnrichedClick implements Serializable {
  ...
  @SchemaFieldName(ClickSchema.SOURCE_COUNTRY)
  public abstract String getSourceCountry();

  @SchemaFieldName(ClickSchema.SOURCE_REGION)
  public abstract String getSourceRegion();

  public static Builder builder() {
    return new AutoValue_EnrichedClick.Builder();
  }
  ...
  public abstract static class Builder {
    ...
    public abstract Builder setSourceCountry(String value);

    public abstract Builder setSourceRegion(String value);

    public abstract EnrichedClick build();
  }
}
